...
classes = ('mnc_sp_sp', 'mnc_sp_xl')
train_root = '/data4/wh/Monaco/sub_img/'
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        classes=classes,
        ann_file='/data4/wh/Monaco/annotation/coco_sp_train.json',
        img_prefix=train_root + 'sub_img_train/',
        pipeline=train_pipeline),
    val=dict(
        type='CocoDataset',
        classes=classes,
        ann_file='/data4/wh/Monaco/annotation/coco_sp_test.json',
        img_prefix=test_root + 'sub_img_test/',
