...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_cls=dict(
                type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0, class_weight=[1.0, 1.0, 2.0, 2.0],  #交叉熵，根据类别增加权重
                #type='FocalLoss', use_sigmoid=True, gamma=2.0, alpha=0.25, loss_weight=1.0,  #Focal loss
...
load_from = 'work_dirs/mask_rcnn_nextvit_small_3x/best_bbox_mAP_50_epoch_29_bottleAndWine.pth'
