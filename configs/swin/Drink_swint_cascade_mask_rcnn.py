...
model = dict(
    ...
    roi_head=dict(
        ...
        #mask_head=dict(num_classes=classes_num),
        # 测试时取消分割头
...
train_root = '/data4/wh/bottle_data/' #'/data4/wh/DrinkData/'
...
#load_from = 'checkpoints/MMDet_cascade_mask_rcnn_swin_tiny_patch4_window7.pth'
load_from = 'work_dirs/Drink_swint_cascade_mask_rcnn/epoch_50_bottleAndWine.pth'