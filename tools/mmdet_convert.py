...
def convert_test(cfg_path,
    ...
    if enable_mask:
        output_names=["num_detections", "boxes", "scores", "classes","mask"]
    else:
    ...
    save_engine_path = os.path.join(os.path.split(trt_model_path)[0], "model.plan")
...
def main():
    ...
    parser.add_argument(
        '--opt_shape_param',
        default='[ [ [1,3,32,32], [1,3,800,1344], [1,3,1344,1344] ] ]',
        #default='[ [ [1,3,1344,1344], [1,3,1344,1344], [1,3,1344,1344] ] ]',
        #default='[ [ [1,3,1920,1920], [1,3,1920,1920], [1,3,1920,1920] ] ]',
